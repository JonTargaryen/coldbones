...
const en: Translations = {
  ...
  uploadHint: 'Images, PDF — up to 20 MB each',
  clearAll: 'Clear All',
...
const hi: Translations = {
  ...
  uploadHint: 'Images, PDF — प्रत्येक 20 MB तक',
  clearAll: 'सब हटाएँ',
...
const es: Translations = {
  ...
  uploadHint: 'Images, PDF — hasta 20 MB cada uno',
...
const bn: Translations = {
  ...
  uploadHint: 'Images, PDF — প্রতিটি ২০ MB পর্যন্ত',
  clearAll: 'সব মুছুন',
